...
from app.users.permissions import IsAdmin
import pandas as pd
...
def create_product(request):
    """
    Créer un produit complet (nom + prix + unité) directement validé
    """
    name = request.data.get('name')
    ...
    # Créer produit validé directement
    product = Product.objects.create(
        name=name,
        price=price,
        unit=unit,
...
def validate_product(request, pk):
    ...
    try:
        ...
        product.stock = request.data.get('stock', 0)
